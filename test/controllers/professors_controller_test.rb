...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { email_id: @professor.email_id, name: @professor.name, research: @professor.research, website: @professor.website } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email_id: @professor.email_id, name: @professor.name, research: @professor.research, website: @professor.website } }
